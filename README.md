...
|:--------|:---------|:------|
| macOS V1.0 | GitHub Releases (https://github.com/skillshen-boop/SculptBox/releases/latest) | ZBrush 2026+ |
...
- One-Click Deploy - Bridge installation in under a minute

---

## Links

- Website: sculptbox.net
